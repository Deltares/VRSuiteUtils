...
def read_assessment_betas(filename):
    ...
    probabilities[list_of_cols_to_change] = probabilities[list_of_cols_to_change].apply(
        lambda x: beta_to_pf(x)
    )
...
def get_traject_prob_development(
    ...
    initial_beta,
    option_dir,
    calc_type="Veiligheidsrendement",
    mechanisms=["StabilityInner", "Piping", "Overflow"],
):
