...
def plot_vakindeling(
    shapefile, output_loc, basemap_provider=ctx.providers.Stamen.TonerLite
):
...
def plot_pf_length_cost(
    ...
    ax.legend()
    plt.savefig(
        output_dir.joinpath("versterkte lengte vs faalkans in {}.png".format(year)),
        dpi=300,
        bbox_inches="tight",
    )
