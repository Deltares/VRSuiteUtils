...
-- KEYS TO BE FILLED: '42', 1500357, 180, 1, 7.970000000000001, 10.97, 0.25, data from profile and numerics settings
DELETE FROM [HydraulicModels];
INSERT INTO [HydraulicModels] VALUES (1, 1, 'WTI 2017');

DELETE FROM [Sections];
INSERT INTO [Sections] VALUES (1, 1, 1, '42', '42', -999,-999,-999,-999, 1500357, 1500357, 100, 180, 0);

DELETE FROM [SectionCalculationSchemes];
INSERT INTO [SectionCalculationSchemes] VALUES (1, 101, 1);

DELETE FROM [DesignTables];
INSERT INTO [DesignTables] VALUES (1, 101, 1, 1, 3, 1, NULL, 7.970000000000001, 10.97, 0.25, 0, 0, 0);
...
INSERT INTO [VariableDatas] VALUES (1, 101, 1, 1, 1, 8.97, 0, 0, NULL, NULL, NULL, 1, 0, 300);
...
INSERT INTO [CalculationProfiles] VALUES (1, 1, -49.520, -2.000, 1.000);
INSERT INTO [CalculationProfiles] VALUES (1, 2, -42.510, 0.010, 1.000);
INSERT INTO [CalculationProfiles] VALUES (1, 3, -13.850, 7.110, 1.000);
INSERT INTO [CalculationProfiles] VALUES (1, 4, -5.490, 7.710, 1.000);
INSERT INTO [CalculationProfiles] VALUES (1, 5, -0.680, 8.960, 1.000);
INSERT INTO [CalculationProfiles] VALUES (1, 6, -0.650, 8.970, 1.000);
--Example line: INSERT INTO [CalculationProfiles] VALUES (1, 1, -17, 5.13, 1);

DELETE FROM [Profiles];
INSERT INTO [Profiles] VALUES (1, 1, -49.520, -2.000);
INSERT INTO [Profiles] VALUES (1, 2, -42.510, 0.010);
INSERT INTO [Profiles] VALUES (1, 3, -13.850, 7.110);
INSERT INTO [Profiles] VALUES (1, 4, -5.490, 7.710);
INSERT INTO [Profiles] VALUES (1, 5, -0.680, 8.960);
INSERT INTO [Profiles] VALUES (1, 6, -0.650, 8.970);
...
INSERT INTO [FORELANDS] VALUES (1, 1, -125.000, -0.530);
INSERT INTO [FORELANDS] VALUES (1, 2, -42.510, 0.010);
