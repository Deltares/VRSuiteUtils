...
-- KEYS TO BE FILLED: '42', 1500357, 1, 5.1, 11.75, 0.25
-- [Areas] ;
DELETE FROM [Areas];
...
INSERT INTO [Sections] VALUES (  1, 1, 1, '42' , '42'  , -999 , -999, -999 , -999,  1500357,  1500357, 100, 180, 1); -- Non-tidal river, Rhine-dominated;																
