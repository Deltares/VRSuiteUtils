...
-- KEYS TO BE FILLED: 'LocationName', HLCDID, TIMEINTEGRATION, Hmin, Hmax, Hstep
-- [Areas] ;
DELETE FROM [Areas];
...
INSERT INTO [Sections] VALUES (  1, 1, 1, 'LocationName' , 'LocationName'  , -999 , -999, -999 , -999,  HLCDID,  HLCDID, 100, 180, 1); -- Non-tidal river, Rhine-dominated;																
