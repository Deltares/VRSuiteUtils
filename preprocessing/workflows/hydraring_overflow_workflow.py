...
if __name__ == "__main__":
    ...
    # working directory:
    work_dir = Path(
        r"c:\Users\klerk_wj\OneDrive - Stichting Deltares\00_Projecten\11_VR_HWBP\test_overslag"
    )
    ...
    database_paths = [
        Path(
            r"c:\Users\klerk_wj\OneDrive - Stichting Deltares\00_Projecten\11_VR_HWBP\test_overslag\2023"
        )
    ]
