...
def main(work_dir,database_paths,
    ...
    for database_path in database_paths:
        for count, location in overflow_input_object.hring_data.iterrows():
            ...
            #make ini file:
            computation.make_ini_file(loc_output_dir,Path(os.getcwd()).parent.parent.joinpath('tests','test_data','general','ini_reference_overflow.ini'),database_path,config_db_path)
            #run Hydra-Ring
...
if __name__ == '__main__':
    ...
    # location of HRD config:
    # HRD_config_path = Path()
