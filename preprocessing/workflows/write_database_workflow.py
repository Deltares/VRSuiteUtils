...
def write_database_main(traject_name : str,
    ...
    #read water levels
    waterlevel_results = read_waterlevel_data(waterlevel_results_path, hydra_model='hydra_ring')

    #read mechanism_data and store in dictionary. We must have overflow and stabiliteit. Others are optional
    mechanism_data = {'overslag': read_overflow_data(overflow_results_path, hydra_model='hydra_ring'), 
