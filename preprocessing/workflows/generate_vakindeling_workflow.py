...
def vakindeling_main(input_csv_path: str,
                     traject_id: str,
                     output_path: Path,
    ...
    traject.generate_vakindeling_shape(input_csv_path)
    ...
    traject.vakindeling_shape.to_file(
        Path(output_path).joinpath("Vakindeling_{}.geojson".format(traject_id)),
        driver="GeoJSON",
    )
    ...
    plot_vakindeling(
        ...
        Path(output_path).joinpath("Vakindeling_{}.png".format(traject_id)),
    )
...
#     output_path = r"c:\VRM\test_vakindeling_workflow\result"
#     vakindeling_main(traject, file_location, Path(output_path))
