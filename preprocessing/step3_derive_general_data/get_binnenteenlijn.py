...
coordinates_teen = []
# create an empty list for the name of the profile corresponding to the coordinates of the binnenteen
name_teen = []
...
for png_file in characteristic_profile_dir.glob('*.png'):
    ...
    line_x = interp1d([-50, 75], [x_fs, x_hl])
...
gdf.to_json()
gdf.to_file(output_dir.joinpath("teenlijn traject_38-1_line2.geojson"), driver="GeoJSON")
